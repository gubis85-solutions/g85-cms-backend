...
export interface ApiCareerCareer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    postStatus: Schema.Attribute.Enumeration<['Open', 'Closed', 'Archived']>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCsrEventCsrEvent extends Struct.CollectionTypeSchema {
  collectionName: 'csr_events';
  info: {
    displayName: 'CSR Event';
    pluralName: 'csr-events';
    singularName: 'csr-event';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCsrInitiativeCsrInitiative
  extends Struct.CollectionTypeSchema {
  collectionName: 'csr_initiatives';
  info: {
    displayName: 'CSR Initiative';
    pluralName: 'csr-initiatives';
    singularName: 'csr-initiative';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::csr-initiative.csr-initiative'
    > &
      Schema.Attribute.Private;
...
export interface ApiNewsFeedNewsFeed extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Company Insight', 'Security Insight']
    >;
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pane: Schema.Attribute.Relation<'manyToOne', 'api::team-pane.team-pane'>;
    ...
    secondaryNote: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTeamPaneTeamPane extends Struct.CollectionTypeSchema {
  collectionName: 'team_panes';
  info: {
    displayName: 'team-pane';
    pluralName: 'team-panes';
    singularName: 'team-pane';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    key: Schema.Attribute.Enumeration<
      ['executive_leadership', 'department_heads']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'department_heads'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::team-pane.team-pane'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
